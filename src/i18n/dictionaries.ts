...
export const dicts: Record<Locale, Dict> = {
  en: base({
    metaTitle: 'Online Decibel Meter – Measure Sound in Your Browser',
    metaDescription: 'Use this free online decibel meter to check microphone input strength and, after calibration, estimate sound levels in dBA, dBC or dBZ. No download required.',
    ...
    heroSub: 'Check microphone input strength immediately, or calibrate your device for estimated environmental sound levels.',
    ...
    calibrationUncal: 'Uncalibrated — showing microphone input strength, not environmental dB', calibrationCal: 'Calibrated',
    ...
    statusCalRequired: 'Calibration required for environmental dB', inputStrength: 'Microphone Input Strength',
    ...
    step2t: 'Watch the live panel', step2d: 'Read current, average and peak input strength, or calibrated sound-level statistics, with the matching live graph.',
    ...
    sessionTitle: 'Sessions & export', sessionBody: 'Each run keeps duration and mode-aware session statistics. Percentage feedback stays visual-only; environmental estimates are exported only when compatible calibration is active.',
    faqTitle: 'Frequently asked questions',
    faq: [
      { q: 'Is this a calibrated sound level meter?', a: 'No. Browser microphones vary by device, so readings are estimates. For safety or legal decisions, use a calibrated Class 1 or Class 2 meter.' },
      { q: 'Is my audio uploaded or recorded?', a: 'No. All processing runs locally in your browser via the Web Audio API. Audio never leaves your device through this site.' },
      { q: 'Why does the meter show --?', a: 'The idle display shows -- until you grant microphone permission and press Start. No simulated values are ever shown.' },
      { q: 'What do dB, dBA, Fast and Slow mean?', a: 'dB is the sound level unit. A-weighting (dBA) approximates human hearing; C is flatter; Z is unweighted. Fast (125 ms) follows peaks, Slow (1 s) smooths them.' },
      { q: 'Can I save a session?', a: 'Yes. Export the current session as CSV or JSON, or keep a local history in this browser. Nothing is sent to a server.' },
    ],
  ...
  de: base({
    ...
    metaDescription: 'Kostenloser Dezibelmesser ohne App: Mikrofonstärke sofort prüfen und nach Kalibrierung Schallpegel in dBA, dBC oder dBZ schätzen. Kein Download nötig.',
    navGuides: 'Anleitungen', navMeasure: 'Messen', headerTag: 'Browser-Schätzwert',
    heroEyebrow: 'Kostenloser Dezibelmesser — ohne App, kein Download', heroH1: 'Dezibelmesser Online',
    heroSub: 'Prüfen Sie sofort die Mikrofon-Eingangsstärke oder schätzen Sie nach Kalibrierung den Schallpegel in dBA, dBC oder dBZ – direkt im Browser, kostenlos und ohne App.',
    ...
    statusCalRequired: 'Kalibrierung erforderlich', inputStrength: 'Mikrofon-Eingangsstärke',
    ...
    calTitle: 'Kalibrierung', calOffset: 'Offset in dB', calLabel: 'Referenznotiz (z. B. „Büro-Kalibrator 94 dB“)',
    ...
    step2t: 'Live-Anzeige beobachten', step2d: 'Lesen Sie aktuelle und gemittelte Eingangsstärke oder kalibrierte Schallpegel mit Live-Graph ab.',
    ...
    sessionTitle: 'Sitzungen & Export', sessionBody: 'Jeder Lauf speichert Dauer und modusabhängige Statistik. Prozentwerte bleiben reine Anzeige; Schallpegel werden nur mit kompatibler Kalibrierung exportiert.',
  ...
  it: base({
    ...
    metaDescription: 'Fonometro online gratis senza download: controlla subito il segnale del microfono e, dopo la calibrazione, stima i decibel in dBA, dBC o dBZ.',
    navGuides: 'Guide', navMeasure: 'Misura', headerTag: 'Stima browser',
    heroEyebrow: 'Fonometro online gratis — senza download', heroH1: 'Fonometro Online',
    heroSub: 'Controlla subito il segnale del microfono e, dopo la calibrazione, stima il livello sonoro in dBA, dBC o dBZ — direttamente nel browser, gratis e senza app.',
    ...
    statusCalRequired: 'Calibrazione necessaria', inputStrength: 'Segnale del microfono',
    ...
    calTitle: 'Calibrazione', calOffset: 'Offset in dB', calLabel: 'Nota di riferimento (es. “calibratore 94 dB”)',
    ...
    step2t: 'Osserva il pannello live', step2d: 'Leggi segnale istantaneo e medio oppure livelli calibrati in dBA con il grafico live.',
    ...
    sessionTitle: 'Sessioni ed export', sessionBody: 'Ogni sessione salva durata e statistiche. La percentuale resta solo visiva; i livelli ambientali si esportano solo con calibrazione compatibile attiva.',
  ...
  ja: base({
    ...
    metaDescription: '無料のブラウザ・デシベル測定ツール。マイク入力レベルをすぐ確認し、校正後はdBA・dBC・dBZの推定値を表示。ダウンロード不要。',
    navGuides: 'ガイド', navMeasure: '測定', headerTag: 'ブラウザ推定',
    heroEyebrow: '無料オンラインデシベル計 — ダウンロード不要', heroH1: 'オンラインデシベル測定',
    heroSub: 'マイク入力レベルをすぐに確認。校正後はdBA・dBC・dBZの環境騒音レベルの推定値を表示します。処理はすべてブラウザ内で完結します。',
    ...
    statusCalRequired: '校正が必要です', inputStrength: 'マイク入力レベル',
    ...
    calTitle: '校正', calOffset: 'オフセット (dB)', calLabel: '基準メモ（例: 校正器94dB）',
    ...
    step2t: 'ライブパネルを見る', step2d: '入力レベルまたは校正後のdBA推定値をライブグラフとともに確認します。',
    ...
    sessionTitle: 'セッションと出力', sessionBody: '各セッションは時間と統計を保持します。パーセント表示は目安のみで、環境騒音レベルの出力には互換性のある校正が必要です。',
    faqTitle: 'よくある質問',
    faq: [
  ...
  es: base({
    ...
    metaDescription: 'Sonómetro online gratis sin descargas: comprueba la señal del micrófono y, tras calibrar, estima los decibelios en dBA, dBC o dBZ.',
    navGuides: 'Guías', navMeasure: 'Medir', headerTag: 'Estimación del navegador',
    heroEyebrow: 'Sonómetro online gratis — sin descargas', heroH1: 'Medidor de Decibelios Online',
    heroSub: 'Comprueba al instante la señal del micrófono y, tras calibrar tu dispositivo, estima el nivel sonoro en dBA, dBC o dBZ — todo en tu navegador, gratis y sin app.',
    ...
    statusCalRequired: 'Calibración necesaria', inputStrength: 'Señal del micrófono',
    ...
    calTitle: 'Calibración', calOffset: 'Desviación en dB', calLabel: 'Nota de referencia (ej. «calibrador 94 dB»)',
    ...
    step2t: 'Observa el panel en vivo', step2d: 'Lee la señal instantánea y media o los decibelios calibrados en dBA con el gráfico en vivo.',
    ...
    sessionTitle: 'Sesiones y exportación', sessionBody: 'Cada sesión guarda duración y estadísticas. El porcentaje es solo visual; los niveles ambientales solo se exportan con calibración compatible activa.',
  ...
  fr: base({
    ...
    metaDescription: 'Sonomètre en ligne gratuit sans téléchargement : vérifiez le signal du micro puis, après calibrage, estimez les décibels en dBA, dBC ou dBZ.',
    navGuides: 'Guides', navMeasure: 'Mesurer', headerTag: 'Estimation navigateur',
    heroEyebrow: 'Sonomètre en ligne gratuit — sans téléchargement', heroH1: 'Sonomètre en Ligne',
    heroSub: 'Vérifiez aussitôt le signal du microphone puis, après calibrage, estimez le niveau sonore en dBA, dBC ou dBZ — dans votre navigateur, sans application.',
    ...
    statusCalRequired: 'Calibrage requis', inputStrength: 'Signal du microphone',
    ...
    calTitle: 'Calibrage', calOffset: 'Décalage en dB', calLabel: 'Note de référence (ex. « calibreur 94 dB »)',
    ...
    step2t: 'Suivre le panneau live', step2d: 'Lisez le signal instantané et moyen ou les décibels calibrés en dBA avec le graphique live.',
    ...
    sessionTitle: 'Sessions et export', sessionBody: 'Chaque session conserve durée et statistiques. Le pourcentage reste purement visuel ; les niveaux ambiants ne s’exportent qu’avec un calibrage compatible actif.',
  ...
  pt: base({
    ...
    metaDescription: 'Medidor de decibéis online e grátis sem download: verifique o sinal do microfone e, após calibrar, estime os decibéis em dBA, dBC ou dBZ.',
    navGuides: 'Guias', navMeasure: 'Medir', headerTag: 'Estimativa do navegador',
    heroEyebrow: 'Medidor de decibéis online grátis — sem download', heroH1: 'Medidor de Decibéis Online',
    heroSub: 'Verifique na hora o sinal do microfone e, após calibrar, estime o nível sonoro em dBA, dBC ou dBZ — direto no navegador, grátis e sem app.',
    ...
    statusCalRequired: 'Calibração necessária', inputStrength: 'Sinal do microfone',
    ...
    calTitle: 'Calibração', calOffset: 'Desvio em dB', calLabel: 'Nota de referência (ex. “calibrador 94 dB”)',
    ...
    step2t: 'Observe o painel ao vivo', step2d: 'Leia o sinal instantâneo e médio ou os decibéis calibrados em dBA com o gráfico ao vivo.',
    ...
    sessionTitle: 'Sessões e exportação', sessionBody: 'Cada sessão guarda duração e estatísticas. A percentagem é só visual; os níveis ambientes só se exportam com calibração compatível ativa.',
  ...
  ko: base({
    ...
    metaDescription: '무료 온라인 데시벨 측정기: 마이크 입력 레벨을 바로 확인하고, 교정 후 dBA·dBC·dBZ 추정값을 표시. 다운로드 불필요.',
    navGuides: '가이드', navMeasure: '측정', headerTag: '브라우저 추정치',
    heroEyebrow: '무료 온라인 데시벨 측정기 — 다운로드 불필요', heroH1: '온라인 데시벨 측정기',
    heroSub: '마이크 입력 레벨을 바로 확인하고, 기기를 교정한 뒤 dBA·dBC·dBZ 환경 소음 추정값을 표시하세요. 모든 처리는 브라우저 안에서 이루어집니다.',
    ...
    statusCalRequired: '교정이 필요합니다', inputStrength: '마이크 입력 레벨',
    ...
    calTitle: '교정', calOffset: '오프셋 (dB)', calLabel: '기준 메모 (예: 교정기 94dB)',
    ...
    step2t: '라이브 패널 보기', step2d: '입력 레벨 또는 교정된 dBA 추정값을 라이브 그래프와 함께 확인하세요.',
    ...
    sessionTitle: '세션 및 내보내기', sessionBody: '각 세션은 시간과 통계를 저장합니다. 퍼센트는 화면 표시용이며, 환경 소음 출력에는 호환 교정이 필요합니다.',
    faqTitle: '자주 묻는 질문',
    faq: [
