...
export const dicts: Record<Locale, CoreDict> = {
  en: base({
    ...
    faq: [
      ...
      { q: 'Does iPhone have a decibel meter?', a: 'iPhone has no built-in decibel readout, but Safari works as one: open this free online decibel meter, press Start, allow the microphone, and you get a live estimated dBA display. No app install needed. See our iPhone decibel meter guide.' },
      { q: 'Is there a decibel meter app?', a: 'Yes — but you do not need to install one for a quick check. This browser page works as a free decibel meter app on iPhone and Android: live dBA, dBC or dBZ, Leq, min and max, plus CSV or JSON export. Native apps only win for offline or background logging.' },
      { q: 'Is there a free decibel meter app?', a: 'Yes, this site is a free decibel meter app that runs in the browser. No account, no download, audio stays on your device. Press Start Measuring on the homepage to use it.' },
      { q: 'What is a decibel meter?', a: 'A decibel meter, also called a sound level meter or noise meter, measures sound intensity in decibels (dB). This site is an online decibel meter: it reads your microphone and shows an estimated level in dBA, dBC or dBZ.' },
      { q: 'What is a decibel meter called?', a: 'Sound level meter, noise meter, SPL meter and sound meter all mean the same function: measuring sound in decibels. Professionals use calibrated Class 1 or Class 2 hardware; browsers give estimates.' },
      { q: 'Are decibel meter apps accurate?', a: 'They are useful estimates, not certified readings. Two phones on the same sound often differ by 5–10 dB, phone mics read too high below ~30 dBA and clip above ~95–100 dBA, and bass is under-reported. Calibrate against a known reference for better device-specific agreement.' },
      { q: 'How accurate is a phone decibel meter?', a: 'Treat it as rounded to a few dB. Use 30–60 second averages or Leq instead of instants, ignore decimals, calibrate once per phone, and never use it for workplace, legal or medical decisions.' },
      { q: 'How to use a decibel meter?', a: 'Allow the microphone, hold the device at ear height with the mic uncovered, stay silent, wait a few seconds, then read the average or Leq over 30–60 seconds. Keep distance, weighting (A/C/Z) and Fast/Slow the same for comparisons.' },
      { q: 'How does a decibel meter work?', a: 'It converts microphone sound into an RMS level, applies A, C or Z frequency weighting, smooths with Fast (125 ms) or Slow (1 s) response, and accumulates an energy-average Leq. This browser meter does all of that locally via the Web Audio API.' },
      { q: 'How to calibrate a decibel meter?', a: 'Place the device next to a stable known reference, note the difference, and save it as an offset. Keep the same microphone, position, weighting and settings. See the calibration guide for the four steps.' },
      { q: 'How much does a decibel meter cost?', a: 'This online meter is free. Hardware meters range from budget sound checkers to calibrated Class 2 instruments costing hundreds and Class 1 instruments costing thousands. For formal compliance you need calibrated hardware.' },
      { q: 'What to look for in a decibel meter?', a: 'Check calibration support, A/C/Z weighting, Fast/Slow response, Leq averaging, and export. For browser checks the same applies: weighting options, calibration profiles, and local CSV/JSON export — all included here.' },
      { q: 'Does a decibel meter measure bass?', a: 'Only partly on phones. Phone capsules favour speech frequencies, so deep bass reads lower than it sounds. Use C or Z weighting for bass-heavy sound, and a calibrated meter with a proper capsule for real low-frequency work.' },
